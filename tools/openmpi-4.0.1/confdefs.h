...
#define OPAL_PACKAGE_STRING "Open MPI gitpod@b224hisl-openroadflowsc-475mpzqglnx Distribution"
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='-I/workspace/OpenROAD-flow-scripts/tools/openmpi-4.0.1/opal/mca/hwloc/hwloc201/hwloc/include   ' FFLAGS='' LDFLAGS='  ' --enable-shared --disable-static   --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
