...
#define PMIX_CONFIGURE_CLI " \'--with-pmix-symbol-rename=OPAL_MCA_PMIX3X_\' \'--enable-embedded-mode\' \'--disable-debug\' \'--disable-pmix-timing\' \'--without-tests-examples\' \'--disable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--enable-embedded-libevent\' '--with-libevent-header=\"opal/mca/event/external/external.h\"' \'--enable-embedded-hwloc\' '--with-hwloc-header=\"opal/mca/hwloc/hwloc201/hwloc201.h\"' \'CFLAGS=-O3 -DNDEBUG  \' \'CPPFLAGS=-I/workspace/OpenROAD-flow-scripts/tools/openmpi-4.0.1 -I/workspace/OpenROAD-flow-scripts/tools/openmpi-4.0.1 -I/workspace/OpenROAD-flow-scripts/tools/openmpi-4.0.1/opal/include -I/workspace/OpenROAD-flow-scripts/tools/openmpi-4.0.1/opal/include -I/workspace/OpenROAD-flow-scripts/tools/openmpi-4.0.1/opal/mca/hwloc/hwloc201/hwloc/include   \' \'--cache-file=/dev/null\' \'--srcdir=.\' \'--disable-option-checking\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Tue Mar 28 05:41:01 UTC 2023"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "b224hisl-openroadflowsc-475mpzqglnx"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "gitpod"
...
#define PMIX_PACKAGE_STRING "PMIx gitpod@b224hisl-openroadflowsc-475mpzqglnx Distribution"
